...
url = 'https://tuoitre.vn/tim-kiem.htm?keywords='              # starting url
...
for each_keyword in list_keywords:
    # Download the page.
    print('Checking tuoitre.vn key word: {}...'.format(each_keyword))
    ...
    list_element_all_result = soup.select('h3')
    ...
    for each_element in list_element_all_result:
        ...
        result_link = 'https://tuoitre.vn' + list_element_chap[0].get('href')
