...
# starting url
url = 'http://www.mangatown.com/manga/mob_psycho_100'
# store list in ./SManga
...
while True:
    # Download the page.
    print('Checking manga Mob Psycho 100...')
    time.sleep(5)
